  ...
  <div class="grid dashboard">
    ...
    <div class="col-12 md:col-6 lg:col-4 contact-form">
      <Panel header="Contact Us" style="height: 100%">
        <div class="grid">
          <div class="col-12">
            <Select class="w-full" v-model="selectCity" :options="selectCities" optionLabel="name" placeholder="Select a City" />
          </div>
          <div class="col-12">
            <InputText class="w-full" type="text" placeholder="Name" />
          </div>
          <div class="col-12">
            <InputText class="w-full" type="text" placeholder="Age" />
          </div>
          <div class="col-12">
            <InputText class="w-full" type="text" placeholder="Message" />
          </div>
          <div class="col-12">
            <Button class="w-full" type="button" label="Send" icon="pi pi-envelope" />
          </div>
        </div>
      </Panel>
    </div>
